...
"""
Construction dataset which returns image_id for evaluation.
...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train": (root / "images", root / f'coco.json'),
        "val": (root / "images", root / f'coco_val.json'),
    }

    img_folder, ann_file = PATHS[image_set]
    dataset = constructionDetection(img_folder, ann_file, transforms=make_construction_transforms(image_set), return_masks=args.masks)
    return dataset
