...
def get_annotation_info(binary_mask, image_size, image_id, category_id, segmentation_id, iscrowd):

    category_info = {"id": category_id, "is_crowd": iscrowd}
    annotation_info = create_annotation_info(segmentation_id, image_id, category_info, binary_mask, image_size, tolerance=2)
    return annotation_info    